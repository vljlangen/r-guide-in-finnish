  ...
  bookdown::gitbook:
    config:
      toc:
        ...
        before: |
          <li><a href="https://vldesign.kapsi.fi/r-guide-in-english/"><i class="fa fa-language fa-fw"></i> English version<span></span></a></li>
        after: |
...
Tämä opas on saatavilla myös [englanniksi](https://vldesign.kapsi.fi/r-guide-in-english/): this short guide is available also [in English](https://vldesign.kapsi.fi/r-guide-in-english/). 
